...
import 'package:one/adminpages/main.dart';
import 'package:one/adminpages/mainDrinks.dart';
import '../login.dart';
                ...
                Center(
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('Logout', style: TextStyle(fontWeight: FontWeight.w900),)),
                    ),
                  ),
                )
              ],
