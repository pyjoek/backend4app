    ...
    <div class="container">
        <form action = "/placeorder" method="post" class="col-md-8 offset-md-2 mt-3">@csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="foodname" class="form-control" id="exampleInputPassword1" value="{{$food->foodname}}" readonly>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Table Name</label>
                <input type="text" name="tablename" class="form-control" id="exampleInputPassword1" value="{{$table->name}}" readonly>
            </div>
